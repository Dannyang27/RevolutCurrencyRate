...
enum class FlagEnum(val drawable: Int, val currencyName: String){
    ...
    CNY(R.drawable.cny, "Renminbi (Yuan)"),
    CZK(R.drawable.czk, "Czech Koruna"),
    DKK(R.drawable.dkk, "Danish Kroner"),
    GBP(R.drawable.gbp, "Pound Sterling"),
    HKD(R.drawable.hkd, "Hong Kong Dollar"),
    HRK(R.drawable.hrk, "Croatian Kuna"),
    HUF(R.drawable.huf, "Forint"),
    IDR(R.drawable.idr, "Rupiah"),
    ILS(R.drawable.ils, "New Israeli Sheqel"),
    INR(R.drawable.inr, "Indian Rupee"),
    ISK(R.drawable.isk, "Iceland Krona"),
    JPY(R.drawable.jpy, "Yen"),
    KRW(R.drawable.krw, "Won"),
